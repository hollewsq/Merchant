...
public class H11Adapter extends RecyclerView.Adapter<H11Adapter.RHodel> {

    private Context context;
    private List<HomeBean.ResultBean.RxxpBean.CommodityListBean> commodityList;

    public H11Adapter(Context context) {
        this.context = context;
        this.commodityList = new ArrayList<>();
    }

    public void setCommodityList(List<HomeBean.ResultBean.RxxpBean.CommodityListBean> commodityList) {
    ...
    public RHodel onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_h11, viewGroup, false);
        RHodel rHodel = new RHodel(view);
        return rHodel;
    }
   @Override
    public void onBindViewHolder(@NonNull RHodel rHodel, int i) {
        final HomeBean.ResultBean.RxxpBean.CommodityListBean commodityListBean = commodityList.get(i);
        rHodel.phone.setText(commodityListBean.getCommodityName());
        rHodel.money.setText(commodityListBean.getPrice());
